...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=SAYEDHAWAS\\ALEXSWD5G1;Initial Catalog=Northwind;Integrated Security=True;Encrypt=True;Trust Server Certificate=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.ID).HasName("PK__Employee__3214EC279775B3E6");
        });

        modelBuilder.Entity<EmployeesShortTable>(entity =>
        {
            entity.HasKey(e => e.ID).HasName("PK__Employee__3214EC272E4A0657");
        });
        ...
        modelBuilder.Entity<User>().HasData(new User { Id = 1, Email = "Ahmed@gamil.com", Password = "1234" });
