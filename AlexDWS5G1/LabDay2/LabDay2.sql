...
Select * from EmployeeProfiles Where EmployeeId = 1 
...
Select OrderID , ProductID , UnitPrice , Quantity , UnitPrice * Quantity AS [Price Total]
From [Order Details]
...
Select firstName AS [????? ?????] From Employees
...
-- OR Not AND  in between AND 
Select * from  Employees where EmployeeID = 3 OR EmployeeID = 6 
Select * from  Employees where EmployeeID = 3 OR EmployeeID = 4 OR employeeID = 5

Select * from  Employees where EmployeeID in (3,4,5)
...
Select * from  Employees where FirstName Like '%N%'
Select * from  Employees where FirstName Like '_N__'
Select * from  Employees where FirstName Not Like '_____'

Select * from  Employees where FirstName  Like '_____' OR EmployeeID= 2

Select * from Employees Where firstName Like '_[a,s]%'
Select * from Employees Where firstName Like '_[a-i]%'
Select * from Employees Where firstName Like '_[^a-i]%' --RegExpression 


Select * from Employees Order by FirstName asc --A-Z
Select * from Employees Order by FirstName desc  --A-Z


Select * from  [Order Details] Order by 4 desc


Select *                                  --3
From Employees                            --1
Where EmployeeID >2                       --2
Order by FirstName , LastName , Title     --4

--ERD For HR Human Resource  Employee Profile 
